...
import blackLogo from '../assets/blacklogo2.png'
        ...
        <footer className="p-4 sm:p-6">
            <div className="md:flex md:justify-between md:gap-3">
                <div className="mb-6 md:mb-0">
                    <p href="https://www.google.com" className="flex items-center">
                        <img src={blackLogo} className="mr-3 h-8" alt="AjeboProperty Logo" />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap">AjeboProperty</span>
                    </p>
                </div>
                <div className="md:ml-6 grid grid-cols-2 gap-6 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <li>
                                <p className="hover:underline">Our Partners</p>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 dark:text-gray-400">© 2022 <p href="https://www.google.com" className="hover:underline">AjeboProperty™</p>All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <p href="https://www.google.com" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
